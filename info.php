  ...
  <div id="info">
    <div class="topmenu">
      ...
      <div class="bottom-center">
        <div class="tablinks selectedtab" onclick="function1(event,'treatment')">
          <div class="vertical"> Authorities </div>
        </div>
        <div class="tablinks" onclick="function1(event,'hospitals')">
          <div class="vertical"> Standards </div>
        </div>
        <div class="tablinks" onclick="function1(event,'doctors')">
          <div class="vertical"> Measures </div>
        </div>
        <div class="clear"></div>
      </div>
    </div>
